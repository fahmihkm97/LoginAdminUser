...
<div class="flex">
            ...
            {{-- [POSISI LAMA LOGO DIHAPUS DARI SINI] --}}
            ...
            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                ...
                {{-- 2. LOGO DIPINDAH DI SINI (Menjadi elemen navigasi) --}}
                ...
                @auth
                    {{-- Menggunakan mahasiswas.* agar tetap aktif saat buka halaman create/edit --}}
                    <x-nav-link :href="route('mahasiswas.index')" :active="request()->routeIs('mahasiswas.*')">
                        {{ __('Daftar Mahasiswa') }}
                    </x-nav-link>
                @endauth
...
<div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
    <div class="pt-2 pb-3 space-y-1">
        ...
        @auth
            <x-responsive-nav-link :href="route('mahasiswas.index')" :active="request()->routeIs('mahasiswas.*')">
                {{ __('Daftar Mahasiswa') }}
            </x-responsive-nav-link>
        @endauth
    </div>
